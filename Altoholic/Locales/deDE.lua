...
L["Realm"] = "Server"
L["Realm links successfully deleted"] = "Realm Verbindungen erfolgreich gelöscht"
...
L["TIME_TO_NEXT_WARNING_TOOLTIP"] = "Mindest Zeitlimit, bevor Du die nächste 'Post verfällt' Warnung angezeigt bekommst."
